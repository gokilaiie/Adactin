...
public class CancelOrdrIDOk_BookedItenary 
{
	@Test
	public void main()
	{
		try 
		{
			...
			if(St.equalsIgnoreCase("Adactin.com - Select Hotel"))
			{
				...
				WebElement Werror = driver.findElement(By.id("search_result_error"));
				if(Werror.isDisplayed())
				{
					String Serror = Werror.getText();
					System.out.println("Conf Msg:" +Serror);
				}
			}
			else
			{
