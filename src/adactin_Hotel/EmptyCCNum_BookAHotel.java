...
public class EmptyCCNum_BookAHotel 
{
	@Test
	public void main ()
	{
			...
			driver.get("https://adactinhotelapp.com/index.php");
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
				 	...
				 	driver.findElement(By.id("cc_num")).sendKeys("");
				 	...
				 	WebElement Error = driver.findElement(By.id("cc_num_span"));
					if(Error.isDisplayed())
					{
						System.out.println(Error.getText());
						assertEquals(Error.getText(), "Please Enter your 16 Digit Credit Card Number");
									
					}
					else
					{
						assertEquals(Error, "Please Enter your 16 Digit Credit Card Number");
					}
				}
