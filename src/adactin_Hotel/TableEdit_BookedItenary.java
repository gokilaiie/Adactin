...
public class TableEdit_BookedItenary 
{
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
					 ...
					 if (St.equalsIgnoreCase("Adactin.com - Hotel Booking Confirmation"))
					 {
						...
						driver.findElement(By.id("location_1254546")).click();
						driver.findElement(By.id("location_1254546")).sendKeys("SYD");
						String Edit = driver.findElement(By.id("location_1254546")).getAttribute("value");
