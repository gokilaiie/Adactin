...
public class LstNMNumbrs_BookAHotel 
{
		...
		driver.get("https://adactinhotelapp.com/index.php");
		 ...
		 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
		 {
			 ...
			 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
			 {
			 	...
			 	driver.findElement(By.id("last_name")).sendKeys("12345");
			 	...
			 	WebElement Error = driver.findElement(By.id("last_name_span"));
				...
				{
					assertEquals(Error, "Please Enter LastName in Characters");
				}
			}
