...
public class EmptyCCtype_BookAHotel 
{
	@Test
	public void main ()
	{
			...
			driver.get("https://adactinhotelapp.com/index.php");
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
				 	...
				 	driver.findElement(By.id("cc_type")).sendKeys("");
				 	...
				 	WebElement Error = driver.findElement(By.id("cc_type_span"));
					if(Error.isDisplayed())
					{
						System.out.println(Error.getText());
						assertEquals(Error.getText(), "Please Select your Credit Card Type");	
					}
					else
					{
						assertEquals(Error, "Please Select your Credit Card Type");
					}
				}
