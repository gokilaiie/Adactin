...
public class EmptyPwd_NUR 
{
	...
	public void main ()
	{
		try
		{
			...
			driver.findElement(By.id("captcha-form")).sendKeys("berakoth");
			...
			//Verifying Error
			WebElement Error = driver.findElement(By.id("password_span"));
			if(Error.isDisplayed())
			{
				System.out.println(Error.getText());
				assertEquals(Error.getText(), "Password is Empty");
			}
			else
			{
				assertEquals(Error.getText(), "Password is Empty");
