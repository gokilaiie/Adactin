...
public class EmptyCaptcha_NUR 
{
	...
	public void main()
	{
		try
		{
			...
			//Verifying Error
			WebElement Error = driver.findElement(By.xpath("//label[@id='captcha_span']"));
			if(Error.isDisplayed())
			{
				String Serror = Error.getText();
				System.out.println();
				assertEquals(Serror, "Captcha is Empty");
							
			}
			else
			{
				assertEquals(Error, "Captcha is Empty");
			}
			driver.quit();
		}
		catch (Exception e) 
