...
public class SrchOrder_BookedItenary 
{
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
					 ...
					 if (St.equalsIgnoreCase("Adactin.com - Hotel Booking Confirmation"))
					 {
						...
						String OrdrID = driver.findElement(By.id("order_id_1254839")).getAttribute("value");
						driver.findElement(By.id("order_id_text")).sendKeys(OrdrID);
