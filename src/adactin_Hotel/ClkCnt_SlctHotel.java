		...
		try
		{
			...
			driver.get("https://adactinhotelapp.com/index.php");
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 WebElement SError= driver.findElement(By.id("radiobutton_span"));
				 String Seror = SError.getText();
				 if(SError.isDisplayed())
				 {
					 System.out.println(Seror);
				 }
				String Stitle = driver.getTitle();
				if (Stitle.equalsIgnoreCase("Adactin.com - Select Hotel"))
				 {
