...
public class Editdisabldtxtbox_BookAHotel 
{ 
	@Test
	public void main ()
	{
			...
			driver.get("https://adactinhotelapp.com/index.php");
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
				 	...
				 	//Editing disabled textboxes
				 	driver.findElement(By.id("hotel_name_dis")).click();
				 	driver.findElement(By.id("hotel_name_dis")).sendKeys("Name");
				 	
				 	driver.findElement(By.id("location_dis")).click();
				 	driver.findElement(By.id("location_dis")).clear();
