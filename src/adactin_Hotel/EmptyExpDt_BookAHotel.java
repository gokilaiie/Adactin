...
public class EmptyExpDt_BookAHotel
{
	@Test
	public void main ()
	{
			...
			driver.get("https://adactinhotelapp.com/index.php");
			 ...
			 if (title.equalsIgnoreCase("Adactin.com - Select Hotel"))
			 {
				 ...
				 if (Stitle.equalsIgnoreCase("Adactin.com - Book A Hotel"))
				 {
				 	...
				 	driver.findElement(By.id("cc_exp_month")).sendKeys("");
				 	driver.findElement(By.id("cc_exp_year")).sendKeys("2024");
				 	driver.findElement(By.id("cc_cvv")).sendKeys("123");
				 	driver.findElement(By.id("book_now")).click();
				 	
				 	WebElement Error = driver.findElement(By.id("cc_expiry_span"));
					if(Error.isDisplayed())
					{
						System.out.println(Error.getText());
						assertEquals(Error.getText(), "Please Select your Credit Card Expiry Month");
