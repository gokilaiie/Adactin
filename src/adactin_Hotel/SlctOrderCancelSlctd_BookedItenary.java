...
public class SlctOrderCancelSlctd_BookedItenary 
{
	public static void main (String[] args)
	{
		try
		{
			...
			if (St.equalsIgnoreCase("Adactin.com - Select Hotel"))
			{
				...
				driver.findElement(By.xpath("//input[@value='1255138']")).click();
				driver.findElement(By.xpath("//input[@value='1255140']")).click();
