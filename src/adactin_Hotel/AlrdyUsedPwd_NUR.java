...
public class AlrdyUsedPwd_NUR 
{
	...
	public void main () 
	{
		try
		{
			...
			/*
			 * String SMsg = driver.getTitle();
			 * if(SMsg.equalsIgnoreCase("Adactin.com - New User Registration")) { WebElement
			 * Msg = driver.findElement(By.linkText("Click here to login"));
			 * Msg.isDisplayed(); SMsg = Msg.getText();
			 * System.out.println("User Registered:" +SMsg); assertEquals(SMsg,
			 * "Click here to login"); }
			 */
			//driver.quit();
